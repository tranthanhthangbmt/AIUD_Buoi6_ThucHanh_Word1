        ...
        steps: [
            {
                ...
                icon: "fa-folder-open",
                slideImage: "assets/slides/slide word_Buổi 1_1.png"
            },
            {
                ...
                icon: "fa-font",
                slideImage: "assets/slides/slide word_Buổi 1_8.png"
            },
            {
                ...
                icon: "fa-align-left",
                slideImage: "assets/slides/slide word_Buổi 1_23.png"
            },
            {
                title: "Bước 4: Lưu bài",
                content: "Nhấn File -> Save hoặc Ctrl+S để lưu lại kết quả.",
                icon: "fa-save",
                slideImage: "assets/slides/slide word_Buổi 1_2.png"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        steps: [
            ...
            },
            {
                ...
                icon: "fa-columns",
                slideImage: "assets/slides/slide word_Buổi 1_47.png"
            },
            {
                title: "Bước 3: Drop Cap",
                content: "Vào Insert -> Drop Cap để tạo chữ cái lớn đầu dòng.",
                icon: "fa-font",
                slideImage: "assets/slides/slide word_Buổi 1_53.png"
            }
        ]
    }
];
